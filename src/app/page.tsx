    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-12 bg-slate-400">
      ...
      <div className="border bg-slate-300 rounded-md p-8 w-1/3 mb-4">
        <p className="font-mono">
          This is used to create custom iFrames for the Tangia Raid alert. Once you upload a video you will be given a unique URL that you can paste into your Tangia alert. The URL will spawn an animated version of the video you uploaded for every viewer in a raid. Only Webms supported.
        </p>
